...
from .netmonitor_server_utils import get_hostname_from_target, get_ip_address_from_target
...
netmonitor_app = Flask(__name__)
CORS(netmonitor_app)

api = Api(netmonitor_app, version="1.0", title="netmonitor", description="Comprehensive network monitoring tool",
          default="netmonitor", default_label="")
...
limiter = Limiter(netmonitor_app, key_func=get_remote_address)
