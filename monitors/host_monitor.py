...
def get_hosts():
    ...
    try:
        response = requests.get("http://"+netmonitor+"/hosts")
...
def discovery():
    ...
    ans, unans = scapy.arping(netmask)
    ans.summary()
...
def update_host(host):
    ...
    try:
        rsp = requests.put("http://"+netmonitor+"/hosts", params={"hostname": host["hostname"]}, json=host)
    except requests.exceptions.ConnectionError as e:
