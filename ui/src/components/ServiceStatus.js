...
class ServiceStatus extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            serviceData: {status: [], summary: [], service: {},},
            isLoading: false,
    ...
    fetchServiceStatusData() {
        ...
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/service/status?name='
            ...
            <Grid container direction="column">
                <Grid container direction="row" style={{paddingTop: '10px'}}>
                    ...
                    <Grid item style={{width: '85%', paddingRight: '10px'}}>
                        <StatusGraphsGrid
                            data={this.state.serviceData.status}
                            summary={this.state.serviceData.summary}
