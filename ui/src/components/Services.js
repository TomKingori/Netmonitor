...
class Services extends Component {
    ...
    fetchServices() {
        ...
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/services'
        fetch(requestUrl)
            .then(res => res.json())
            .then((data) => {
    ...
    initiateTraceRoute( target ) {
        ...
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/traceroute?target=' + target
    ...
    fetchTraceRouteResults( target ) {
        ...
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/traceroute?target=' + target + '&token=' + this.state.token
