...
class Hosts extends Component {
    ...
    fetchHosts() {
        ...
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/hosts'
        fetch(requestUrl)
            .then(res => res.json())
            .then((data) => {
                console.log(data)
    ...
    initiateExtendedPortScan(hostname) {
        ...
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/scan?target=' + hostname
    ...
    fetchExtendedPortScanResults(hostname) {
       this.setState({extendedPortScanResults: {result: "retrieving scan results ..."}})
        let requestUrl = process.env.REACT_APP_netmonitor_HOST + '/scan?target=' + hostname + '&token=' + this.state.token
